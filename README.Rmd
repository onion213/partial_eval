...
[![Codecov test coverage](https://codecov.io/gh/onion213/pevalr/graph/badge.svg)](https://app.codecov.io/gh/onion213/pevalr)
<!-- badges: end -->
...
You can install the development version of pevalr from [GitHub](https://github.com/) with:
